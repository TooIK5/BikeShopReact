...
let Header = () => {
  ...
  const userProperties = (<Menu >
    ...
    <Menu.Item key="5"><ArrowRightOutlined /> Выход</Menu.Item>
  </Menu>)
  ...
  return <header className="header">
    ...
    <div className="header-account" >
      <NavLink to={"/account/addAd"}><PlusCircleOutlined size="large" /></NavLink>

      {user ?
        <div className="header-accountData">
          <div className="header-avatarWrapper">
            <Badge count={null} size="small" style={{ border: "none" }}><img src={user.avatar ? user.avatar : "../../assets/img/undefindUser.jpg"} className="header-avatar" /></Badge>
          </div>
