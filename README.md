...
* `src/assets/scss` - put custom app SCSS styles here. Don't forget to import them in `validators.js`
* `src/assets/css` - the same as above but CSS here. Don't forget to import them in `validators.js`
* `src/assets/img` - put images here. Don't forget to use correct path: `assets/img/some.jpg`
* `src/js` - put custom app scripts here
* `src/validators.js` - main app file where you include/import all required libs and init app
...
## Import Another libs:
1. Install libs
2. Import libs in `./validators.js`
``` js
// React example
...
2. Import modules in `./js/validators.js` file
``` js
...
```
3. Create validators.js in `./store`
``` js
import Vue from 'vue'
...
**HTML Usage:**
1. Init component in `validators.js`:
``` js
